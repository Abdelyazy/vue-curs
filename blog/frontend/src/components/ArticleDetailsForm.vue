  ...
  <form class="bg-white rounded-md shadow-md p-8 mb-8" @submit.prevent="handleArticleUpdate">
    <div class="flex justify-between items-center mb-4">
      ...
      <div class="flex gap-4 text-xl">
        <button type="button" @click="articleStore.toggleEditMode" class="cursor-pointer hover:text-blue-500" aria-label="Отменить">
          <FontAwesomeIcon :icon="faArrowRotateLeft" />
        </button>
        <button type="submit" class="cursor-pointer hover:text-blue-500" aria-label="Сохранить">
