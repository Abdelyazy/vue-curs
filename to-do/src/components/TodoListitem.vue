<template>
  ...
  <button  :disabled="completed" @click="$emit('complete-todo')" class="btn btn--check" aria-label="Завершить">
  ...
  <button @click="$emit('remove-todo')" class="btn btn--delete" aria-label="Удалить">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="15" height="22">
      <path
